...
extern KillUserReqDefaultTypeInternal _KillUserReq_default_instance_;
class KillUserRsp;
class KillUserRspDefaultTypeInternal;
extern KillUserRspDefaultTypeInternal _KillUserRsp_default_instance_;
class LoginReq;
...
template<> ::message::KillUserReq* Arena::CreateMaybeMessage<::message::KillUserReq>(Arena*);
template<> ::message::KillUserRsp* Arena::CreateMaybeMessage<::message::KillUserRsp>(Arena*);
...
class KillUserReq PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:message.KillUserReq) */ {
 public:
  inline KillUserReq() : KillUserReq(nullptr) {}
  virtual ~KillUserReq();

  KillUserReq(const KillUserReq& from);
  KillUserReq(KillUserReq&& from) noexcept
    : KillUserReq() {
    *this = ::std::move(from);
  }

  inline KillUserReq& operator=(const KillUserReq& from) {
    CopyFrom(from);
    return *this;
  }
  inline KillUserReq& operator=(KillUserReq&& from) noexcept {
    if (GetArena() == from.GetArena()) {
      if (this != &from) InternalSwap(&from);
    } else {
      CopyFrom(from);
  ...
  static const KillUserReq& default_instance();

  static void InitAsDefaultInstance();  // FOR INTERNAL USE ONLY
  static inline const KillUserReq* internal_default_instance() {
    return reinterpret_cast<const KillUserReq*>(
               &_KillUserReq_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    17;

  friend void swap(KillUserReq& a, KillUserReq& b) {
    a.Swap(&b);
  }
  inline void Swap(KillUserReq* other) {
    if (other == this) return;
    if (GetArena() == other->GetArena()) {
      InternalSwap(other);
    } else {
  ...
  void UnsafeArenaSwap(KillUserReq* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetArena() == other->GetArena());
    InternalSwap(other);
  }
  ...
  inline KillUserReq* New() const final {
    return CreateMaybeMessage<KillUserReq>(nullptr);
  }

  KillUserReq* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
    return CreateMaybeMessage<KillUserReq>(arena);
  }
  void CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void CopyFrom(const KillUserReq& from);
  void MergeFrom(const KillUserReq& from);
  PROTOBUF_ATTRIBUTE_REINITIALIZES void Clear() final;
  bool IsInitialized() const final;
  ...
  inline void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(KillUserReq* other);
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "message.KillUserReq";
  }
  protected:
  explicit KillUserReq(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  private:
  static void ArenaDtor(void* object);
  inline void RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  public:
  ...
  // @@protoc_insertion_point(class_scope:message.KillUserReq)
 private:
  class _Internal;
...
class KillUserRsp PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:message.KillUserRsp) */ {
 public:
  inline KillUserRsp() : KillUserRsp(nullptr) {}
  virtual ~KillUserRsp();

  KillUserRsp(const KillUserRsp& from);
  KillUserRsp(KillUserRsp&& from) noexcept
    : KillUserRsp() {
    *this = ::std::move(from);
  }

  inline KillUserRsp& operator=(const KillUserRsp& from) {
    CopyFrom(from);
    return *this;
  }
  inline KillUserRsp& operator=(KillUserRsp&& from) noexcept {
    if (GetArena() == from.GetArena()) {
      if (this != &from) InternalSwap(&from);
    } else {
      CopyFrom(from);
  ...
  static const KillUserRsp& default_instance();

  static void InitAsDefaultInstance();  // FOR INTERNAL USE ONLY
  static inline const KillUserRsp* internal_default_instance() {
    return reinterpret_cast<const KillUserRsp*>(
               &_KillUserRsp_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    18;

  friend void swap(KillUserRsp& a, KillUserRsp& b) {
    a.Swap(&b);
  }
  inline void Swap(KillUserRsp* other) {
    if (other == this) return;
    if (GetArena() == other->GetArena()) {
      InternalSwap(other);
    } else {
  ...
  void UnsafeArenaSwap(KillUserRsp* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetArena() == other->GetArena());
    InternalSwap(other);
  }
  ...
  inline KillUserRsp* New() const final {
    return CreateMaybeMessage<KillUserRsp>(nullptr);
  }

  KillUserRsp* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
    return CreateMaybeMessage<KillUserRsp>(arena);
  }
  void CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void CopyFrom(const KillUserRsp& from);
  void MergeFrom(const KillUserRsp& from);
  PROTOBUF_ATTRIBUTE_REINITIALIZES void Clear() final;
  bool IsInitialized() const final;
  ...
  inline void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(KillUserRsp* other);
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "message.KillUserRsp";
  }
  protected:
  explicit KillUserRsp(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  private:
  static void ArenaDtor(void* object);
  inline void RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  public:
  ...
  // @@protoc_insertion_point(class_scope:message.KillUserRsp)
 private:
  class _Internal;
...
// int32 type = 3;
inline void TextChatMsgReq::clear_type() {
  type_ = 0;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 TextChatMsgReq::_internal_type() const {
  return type_;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 TextChatMsgReq::type() const {
  // @@protoc_insertion_point(field_get:message.TextChatMsgReq.type)
  return _internal_type();
}
inline void TextChatMsgReq::_internal_set_type(::PROTOBUF_NAMESPACE_ID::int32 value) {
  
  type_ = value;
}
inline void TextChatMsgReq::set_type(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _internal_set_type(value);
  // @@protoc_insertion_point(field_set:message.TextChatMsgReq.type)
}
...
// int32 type = 4;
inline void TextChatMsgRsp::clear_type() {
  type_ = 0;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 TextChatMsgRsp::_internal_type() const {
  return type_;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 TextChatMsgRsp::type() const {
  // @@protoc_insertion_point(field_get:message.TextChatMsgRsp.type)
  return _internal_type();
}
inline void TextChatMsgRsp::_internal_set_type(::PROTOBUF_NAMESPACE_ID::int32 value) {
  
  type_ = value;
}
inline void TextChatMsgRsp::set_type(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _internal_set_type(value);
  // @@protoc_insertion_point(field_set:message.TextChatMsgRsp.type)
}
...
// int32 uid = 1;
inline void KillUserReq::clear_uid() {
  uid_ = 0;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 KillUserReq::_internal_uid() const {
  return uid_;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 KillUserReq::uid() const {
  // @@protoc_insertion_point(field_get:message.KillUserReq.uid)
  return _internal_uid();
}
inline void KillUserReq::_internal_set_uid(::PROTOBUF_NAMESPACE_ID::int32 value) {
  
  uid_ = value;
}
inline void KillUserReq::set_uid(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _internal_set_uid(value);
  // @@protoc_insertion_point(field_set:message.KillUserReq.uid)
}
...
// int32 error = 1;
inline void KillUserRsp::clear_error() {
  error_ = 0;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 KillUserRsp::_internal_error() const {
  return error_;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 KillUserRsp::error() const {
  // @@protoc_insertion_point(field_get:message.KillUserRsp.error)
  return _internal_error();
}
inline void KillUserRsp::_internal_set_error(::PROTOBUF_NAMESPACE_ID::int32 value) {
  
  error_ = value;
}
inline void KillUserRsp::set_error(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _internal_set_error(value);
  // @@protoc_insertion_point(field_set:message.KillUserRsp.error)
}

// int32 uid = 2;
inline void KillUserRsp::clear_uid() {
  uid_ = 0;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 KillUserRsp::_internal_uid() const {
  return uid_;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 KillUserRsp::uid() const {
  // @@protoc_insertion_point(field_get:message.KillUserRsp.uid)
  return _internal_uid();
}
inline void KillUserRsp::_internal_set_uid(::PROTOBUF_NAMESPACE_ID::int32 value) {
  
  uid_ = value;
}
inline void KillUserRsp::set_uid(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _internal_set_uid(value);
  // @@protoc_insertion_point(field_set:message.KillUserRsp.uid)
}
