 ...
 public:
  ...
  class StubInterface {
   public:
    ...
    virtual ::grpc::Status NotifyKillUser(::grpc::ClientContext* context, const ::message::KillUserReq& request, ::message::KillUserRsp* response) = 0;
    std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::message::KillUserRsp>> AsyncNotifyKillUser(::grpc::ClientContext* context, const ::message::KillUserReq& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::message::KillUserRsp>>(AsyncNotifyKillUserRaw(context, request, cq));
    }
    std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::message::KillUserRsp>> PrepareAsyncNotifyKillUser(::grpc::ClientContext* context, const ::message::KillUserReq& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::message::KillUserRsp>>(PrepareAsyncNotifyKillUserRaw(context, request, cq));
    }
    class experimental_async_interface {
     public:
      virtual ~experimental_async_interface() {}
      ...
      #endif
      virtual void NotifyKillUser(::grpc::ClientContext* context, const ::message::KillUserReq* request, ::message::KillUserRsp* response, std::function<void(::grpc::Status)>) = 0;
      #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
      virtual void NotifyKillUser(::grpc::ClientContext* context, const ::message::KillUserReq* request, ::message::KillUserRsp* response, ::grpc::ClientUnaryReactor* reactor) = 0;
      #else
      virtual void NotifyKillUser(::grpc::ClientContext* context, const ::message::KillUserReq* request, ::message::KillUserRsp* response, ::grpc::experimental::ClientUnaryReactor* reactor) = 0;
      #endif
    };
    #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
    typedef class experimental_async_interface async_interface;
  ...
  private:
    ...
    virtual ::grpc::ClientAsyncResponseReaderInterface< ::message::KillUserRsp>* AsyncNotifyKillUserRaw(::grpc::ClientContext* context, const ::message::KillUserReq& request, ::grpc::CompletionQueue* cq) = 0;
    virtual ::grpc::ClientAsyncResponseReaderInterface< ::message::KillUserRsp>* PrepareAsyncNotifyKillUserRaw(::grpc::ClientContext* context, const ::message::KillUserReq& request, ::grpc::CompletionQueue* cq) = 0;
  };
  class Stub final : public StubInterface {
   public:
    Stub(const std::shared_ptr< ::grpc::ChannelInterface>& channel);
    ...
    ::grpc::Status NotifyKillUser(::grpc::ClientContext* context, const ::message::KillUserReq& request, ::message::KillUserRsp* response) override;
    std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::message::KillUserRsp>> AsyncNotifyKillUser(::grpc::ClientContext* context, const ::message::KillUserReq& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::message::KillUserRsp>>(AsyncNotifyKillUserRaw(context, request, cq));
    }
    std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::message::KillUserRsp>> PrepareAsyncNotifyKillUser(::grpc::ClientContext* context, const ::message::KillUserReq& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::message::KillUserRsp>>(PrepareAsyncNotifyKillUserRaw(context, request, cq));
    }
    class experimental_async final :
      public StubInterface::experimental_async_interface {
     public:
      ...
      #endif
      void NotifyKillUser(::grpc::ClientContext* context, const ::message::KillUserReq* request, ::message::KillUserRsp* response, std::function<void(::grpc::Status)>) override;
      #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
      void NotifyKillUser(::grpc::ClientContext* context, const ::message::KillUserReq* request, ::message::KillUserRsp* response, ::grpc::ClientUnaryReactor* reactor) override;
      #else
      void NotifyKillUser(::grpc::ClientContext* context, const ::message::KillUserReq* request, ::message::KillUserRsp* response, ::grpc::experimental::ClientUnaryReactor* reactor) override;
      #endif
     private:
      friend class Stub;
      explicit experimental_async(Stub* stub): stub_(stub) { }
   ...
   private:
    ...
    ::grpc::ClientAsyncResponseReader< ::message::KillUserRsp>* AsyncNotifyKillUserRaw(::grpc::ClientContext* context, const ::message::KillUserReq& request, ::grpc::CompletionQueue* cq) override;
    ::grpc::ClientAsyncResponseReader< ::message::KillUserRsp>* PrepareAsyncNotifyKillUserRaw(::grpc::ClientContext* context, const ::message::KillUserReq& request, ::grpc::CompletionQueue* cq) override;
    ...
    const ::grpc::internal::RpcMethod rpcmethod_NotifyKillUser_;
  };
  static std::unique_ptr<Stub> NewStub(const std::shared_ptr< ::grpc::ChannelInterface>& channel, const ::grpc::StubOptions& options = ::grpc::StubOptions());
  ...
  class Service : public ::grpc::Service {
   public:
    ...
    virtual ::grpc::Status NotifyKillUser(::grpc::ServerContext* context, const ::message::KillUserReq* request, ::message::KillUserRsp* response);
  };
  template <class BaseClass>
  ...
  template <class BaseClass>
  class WithAsyncMethod_NotifyKillUser : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
   public:
    WithAsyncMethod_NotifyKillUser() {
      ::grpc::Service::MarkMethodAsync(5);
    }
    ~WithAsyncMethod_NotifyKillUser() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status NotifyKillUser(::grpc::ServerContext* /*context*/, const ::message::KillUserReq* /*request*/, ::message::KillUserRsp* /*response*/) override {
      abort();
      return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
    }
    void RequestNotifyKillUser(::grpc::ServerContext* context, ::message::KillUserReq* request, ::grpc::ServerAsyncResponseWriter< ::message::KillUserRsp>* response, ::grpc::CompletionQueue* new_call_cq, ::grpc::ServerCompletionQueue* notification_cq, void *tag) {
      ::grpc::Service::RequestAsyncUnary(5, context, request, response, new_call_cq, notification_cq, tag);
    }
  };
  typedef WithAsyncMethod_NotifyAddFriend<WithAsyncMethod_RplyAddFriend<WithAsyncMethod_SendChatMsg<WithAsyncMethod_NotifyAuthFriend<WithAsyncMethod_NotifyTextChatMsg<WithAsyncMethod_NotifyKillUser<Service > > > > > > AsyncService;
  template <class BaseClass>
  ...
  template <class BaseClass>
  class ExperimentalWithCallbackMethod_NotifyKillUser : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
   public:
    ExperimentalWithCallbackMethod_NotifyKillUser() {
    #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
      ::grpc::Service::
    #else
      ::grpc::Service::experimental().
        ...
        MarkMethodCallback(5,
          new ::grpc::internal::CallbackUnaryHandler< ::message::KillUserReq, ::message::KillUserRsp>(
            [this](
    #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
                   ::grpc::CallbackServerContext*
    #else
                   ::grpc::experimental::CallbackServerContext*
    #endif
                     context, const ::message::KillUserReq* request, ::message::KillUserRsp* response) { return this->NotifyKillUser(context, request, response); }));}
    void SetMessageAllocatorFor_NotifyKillUser(
        ::grpc::experimental::MessageAllocator< ::message::KillUserReq, ::message::KillUserRsp>* allocator) {
    #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
      ::grpc::internal::MethodHandler* const handler = ::grpc::Service::GetHandler(5);
    #else
      ::grpc::internal::MethodHandler* const handler = ::grpc::Service::experimental().GetHandler(5);
    #endif
      static_cast<::grpc::internal::CallbackUnaryHandler< ::message::KillUserReq, ::message::KillUserRsp>*>(handler)
              ->SetMessageAllocator(allocator);
    }
    ~ExperimentalWithCallbackMethod_NotifyKillUser() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status NotifyKillUser(::grpc::ServerContext* /*context*/, const ::message::KillUserReq* /*request*/, ::message::KillUserRsp* /*response*/) override {
    ...
    #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
    virtual ::grpc::ServerUnaryReactor* NotifyKillUser(
      ::grpc::CallbackServerContext* /*context*/, const ::message::KillUserReq* /*request*/, ::message::KillUserRsp* /*response*/)
    #else
    virtual ::grpc::experimental::ServerUnaryReactor* NotifyKillUser(
      ::grpc::experimental::CallbackServerContext* /*context*/, const ::message::KillUserReq* /*request*/, ::message::KillUserRsp* /*response*/)
    #endif
      { return nullptr; }
  };
  #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
  typedef ExperimentalWithCallbackMethod_NotifyAddFriend<ExperimentalWithCallbackMethod_RplyAddFriend<ExperimentalWithCallbackMethod_SendChatMsg<ExperimentalWithCallbackMethod_NotifyAuthFriend<ExperimentalWithCallbackMethod_NotifyTextChatMsg<ExperimentalWithCallbackMethod_NotifyKillUser<Service > > > > > > CallbackService;
  #endif
  ...
  template <class BaseClass>
  class WithGenericMethod_NotifyKillUser : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
   public:
    WithGenericMethod_NotifyKillUser() {
      ::grpc::Service::MarkMethodGeneric(5);
    }
    ~WithGenericMethod_NotifyKillUser() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status NotifyKillUser(::grpc::ServerContext* /*context*/, const ::message::KillUserReq* /*request*/, ::message::KillUserRsp* /*response*/) override {
  ...
  template <class BaseClass>
  class WithRawMethod_NotifyKillUser : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
   public:
    WithRawMethod_NotifyKillUser() {
      ::grpc::Service::MarkMethodRaw(5);
    }
    ~WithRawMethod_NotifyKillUser() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status NotifyKillUser(::grpc::ServerContext* /*context*/, const ::message::KillUserReq* /*request*/, ::message::KillUserRsp* /*response*/) override {
    ...
    void RequestNotifyKillUser(::grpc::ServerContext* context, ::grpc::ByteBuffer* request, ::grpc::ServerAsyncResponseWriter< ::grpc::ByteBuffer>* response, ::grpc::CompletionQueue* new_call_cq, ::grpc::ServerCompletionQueue* notification_cq, void *tag) {
      ::grpc::Service::RequestAsyncUnary(5, context, request, response, new_call_cq, notification_cq, tag);
    }
  };
  template <class BaseClass>
  ...
  template <class BaseClass>
  class ExperimentalWithRawCallbackMethod_NotifyKillUser : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
   public:
    ExperimentalWithRawCallbackMethod_NotifyKillUser() {
    #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
      ::grpc::Service::
    #else
      ::grpc::Service::experimental().
        ...
        MarkMethodRawCallback(5,
          new ::grpc::internal::CallbackUnaryHandler< ::grpc::ByteBuffer, ::grpc::ByteBuffer>(
            [this](
                   ...
                   ::grpc::experimental::CallbackServerContext*
    #endif
                     context, const ::grpc::ByteBuffer* request, ::grpc::ByteBuffer* response) { return this->NotifyKillUser(context, request, response); }));
    }
    ~ExperimentalWithRawCallbackMethod_NotifyKillUser() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status NotifyKillUser(::grpc::ServerContext* /*context*/, const ::message::KillUserReq* /*request*/, ::message::KillUserRsp* /*response*/) override {
  ...
  template <class BaseClass>
  class WithStreamedUnaryMethod_NotifyKillUser : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
   public:
    WithStreamedUnaryMethod_NotifyKillUser() {
      ::grpc::Service::MarkMethodStreamed(5,
        new ::grpc::internal::StreamedUnaryHandler<
          ::message::KillUserReq, ::message::KillUserRsp>(
            [this](::grpc::ServerContext* context,
                   ::grpc::ServerUnaryStreamer<
                     ::message::KillUserReq, ::message::KillUserRsp>* streamer) {
                       return this->StreamedNotifyKillUser(context,
                         streamer);
                  }));
    }
    ~WithStreamedUnaryMethod_NotifyKillUser() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable regular version of this method
    ::grpc::Status NotifyKillUser(::grpc::ServerContext* /*context*/, const ::message::KillUserReq* /*request*/, ::message::KillUserRsp* /*response*/) override {
    ...
    // replace default version of method with streamed unary
    virtual ::grpc::Status StreamedNotifyKillUser(::grpc::ServerContext* context, ::grpc::ServerUnaryStreamer< ::message::KillUserReq,::message::KillUserRsp>* server_unary_streamer) = 0;
  };
  typedef WithStreamedUnaryMethod_NotifyAddFriend<WithStreamedUnaryMethod_RplyAddFriend<WithStreamedUnaryMethod_SendChatMsg<WithStreamedUnaryMethod_NotifyAuthFriend<WithStreamedUnaryMethod_NotifyTextChatMsg<WithStreamedUnaryMethod_NotifyKillUser<Service > > > > > > StreamedUnaryService;
  typedef Service SplitStreamedService;
  typedef WithStreamedUnaryMethod_NotifyAddFriend<WithStreamedUnaryMethod_RplyAddFriend<WithStreamedUnaryMethod_SendChatMsg<WithStreamedUnaryMethod_NotifyAuthFriend<WithStreamedUnaryMethod_NotifyTextChatMsg<WithStreamedUnaryMethod_NotifyKillUser<Service > > > > > > StreamedService;
};
