...
static const char* ChatService_method_names[] = {
  ...
  "/message.ChatService/NotifyKillUser",
};
...
ChatService::Stub::Stub(const std::shared_ptr< ::grpc::ChannelInterface>& channel)
  ...
  , rpcmethod_NotifyKillUser_(ChatService_method_names[5], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  {}
...
::grpc::Status ChatService::Stub::NotifyKillUser(::grpc::ClientContext* context, const ::message::KillUserReq& request, ::message::KillUserRsp* response) {
  return ::grpc::internal::BlockingUnaryCall< ::message::KillUserReq, ::message::KillUserRsp, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), rpcmethod_NotifyKillUser_, context, request, response);
}

void ChatService::Stub::experimental_async::NotifyKillUser(::grpc::ClientContext* context, const ::message::KillUserReq* request, ::message::KillUserRsp* response, std::function<void(::grpc::Status)> f) {
  ::grpc::internal::CallbackUnaryCall< ::message::KillUserReq, ::message::KillUserRsp, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(stub_->channel_.get(), stub_->rpcmethod_NotifyKillUser_, context, request, response, std::move(f));
}

void ChatService::Stub::experimental_async::NotifyKillUser(::grpc::ClientContext* context, const ::message::KillUserReq* request, ::message::KillUserRsp* response, ::grpc::experimental::ClientUnaryReactor* reactor) {
  ::grpc::internal::ClientCallbackUnaryFactory::Create< ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(stub_->channel_.get(), stub_->rpcmethod_NotifyKillUser_, context, request, response, reactor);
}

::grpc::ClientAsyncResponseReader< ::message::KillUserRsp>* ChatService::Stub::PrepareAsyncNotifyKillUserRaw(::grpc::ClientContext* context, const ::message::KillUserReq& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncResponseReaderHelper::Create< ::message::KillUserRsp, ::message::KillUserReq, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), cq, rpcmethod_NotifyKillUser_, context, request);
}

::grpc::ClientAsyncResponseReader< ::message::KillUserRsp>* ChatService::Stub::AsyncNotifyKillUserRaw(::grpc::ClientContext* context, const ::message::KillUserReq& request, ::grpc::CompletionQueue* cq) {
  auto* result =
    this->PrepareAsyncNotifyKillUserRaw(context, request, cq);
  result->StartCall();
  return result;
}
...
ChatService::Service::Service() {
  ...
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      ...
      ::grpc::internal::RpcMethod::NORMAL_RPC,
      new ::grpc::internal::RpcMethodHandler< ChatService::Service, ::message::KillUserReq, ::message::KillUserRsp, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(
          [](ChatService::Service* service,
             ::grpc::ServerContext* ctx,
             const ::message::KillUserReq* req,
             ::message::KillUserRsp* resp) {
               return service->NotifyKillUser(ctx, req, resp);
             }, this)));
}
...
::grpc::Status ChatService::Service::NotifyKillUser(::grpc::ServerContext* context, const ::message::KillUserReq* request, ::message::KillUserRsp* response) {
  (void) context;
  (void) request;
  (void) response;
  return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
